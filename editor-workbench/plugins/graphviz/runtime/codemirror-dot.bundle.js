...
var EditorWorkbenchCodeMirrorDotBundle = (() => {
  ...
  var language2 = LRLanguage.define({
    parser: parser2.configure({
      ...
      wrap: parseMixed((node2) => {
        return node2.name == "HTMLStringContent" ? { parser } : null;
      })
    }),
    languageData: {
  ...
  // tools/bundle-src/codemirror-dot-bundle.js
  window.EditorWorkbenchCodeMirror = window.EditorWorkbenchCodeMirror || {};
  window.EditorWorkbenchCodeMirror.dot = dot;
})();
