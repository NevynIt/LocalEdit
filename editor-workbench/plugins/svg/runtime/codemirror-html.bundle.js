...
var EditorWorkbenchCodeMirrorHtmlBundle = (() => {
  ...
  var sharedModule2 = globalThis.EditorWorkbenchCodeMirror && globalThis.EditorWorkbenchCodeMirror.modules && globalThis.EditorWorkbenchCodeMirror.modules["@codemirror/state"];
  if (!sharedModule2) {
    throw new Error("@codemirror/state runtime is not available.");
  }
  var Annotation = sharedModule2["Annotation"];
  var AnnotationType = sharedModule2["AnnotationType"];
  var ChangeDesc = sharedModule2["ChangeDesc"];
  var ChangeSet = sharedModule2["ChangeSet"];
  var CharCategory = sharedModule2["CharCategory"];
  var Compartment = sharedModule2["Compartment"];
  var EditorSelection = sharedModule2["EditorSelection"];
  var EditorState = sharedModule2["EditorState"];
  var Facet = sharedModule2["Facet"];
  var Line = sharedModule2["Line"];
  var MapMode = sharedModule2["MapMode"];
  var Prec = sharedModule2["Prec"];
  var Range2 = sharedModule2["Range"];
  var RangeSet = sharedModule2["RangeSet"];
  var RangeSetBuilder = sharedModule2["RangeSetBuilder"];
  var RangeValue = sharedModule2["RangeValue"];
  var SelectionRange = sharedModule2["SelectionRange"];
  var StateEffect = sharedModule2["StateEffect"];
  var StateEffectType = sharedModule2["StateEffectType"];
  var StateField = sharedModule2["StateField"];
  var Text = sharedModule2["Text"];
  var Transaction = sharedModule2["Transaction"];
  var codePointAt = sharedModule2["codePointAt"];
  var codePointSize = sharedModule2["codePointSize"];
  var combineConfig = sharedModule2["combineConfig"];
  var countColumn = sharedModule2["countColumn"];
  var findClusterBreak = sharedModule2["findClusterBreak"];
  var findColumn = sharedModule2["findColumn"];
  var fromCodePoint = sharedModule2["fromCodePoint"];

  // codemirror-global-shim:@codemirror/view
  var sharedModule3 = globalThis.EditorWorkbenchCodeMirror && globalThis.EditorWorkbenchCodeMirror.modules && globalThis.EditorWorkbenchCodeMirror.modules["@codemirror/view"];
  if (!sharedModule3) {
    throw new Error("@codemirror/view runtime is not available.");
  }
  var BidiSpan = sharedModule3["BidiSpan"];
  var BlockInfo = sharedModule3["BlockInfo"];
  var BlockType = sharedModule3["BlockType"];
  var BlockWrapper = sharedModule3["BlockWrapper"];
  var Decoration = sharedModule3["Decoration"];
  var Direction = sharedModule3["Direction"];
  var EditorView = sharedModule3["EditorView"];
  var GutterMarker = sharedModule3["GutterMarker"];
  var MatchDecorator = sharedModule3["MatchDecorator"];
  var RectangleMarker = sharedModule3["RectangleMarker"];
  var ViewPlugin = sharedModule3["ViewPlugin"];
  var ViewUpdate = sharedModule3["ViewUpdate"];
  var WidgetType = sharedModule3["WidgetType"];
  var __test = sharedModule3["__test"];
  var activateHover = sharedModule3["activateHover"];
  var closeHoverTooltip = sharedModule3["closeHoverTooltip"];
  var closeHoverTooltips = sharedModule3["closeHoverTooltips"];
  var crosshairCursor = sharedModule3["crosshairCursor"];
  var drawSelection = sharedModule3["drawSelection"];
  var dropCursor = sharedModule3["dropCursor"];
  var getDialog = sharedModule3["getDialog"];
  var getDrawSelectionConfig = sharedModule3["getDrawSelectionConfig"];
  var getPanel = sharedModule3["getPanel"];
  var getTooltip = sharedModule3["getTooltip"];
  var gutter = sharedModule3["gutter"];
  var gutterLineClass = sharedModule3["gutterLineClass"];
  var gutterWidgetClass = sharedModule3["gutterWidgetClass"];
  var gutters = sharedModule3["gutters"];
  var hasHoverTooltips = sharedModule3["hasHoverTooltips"];
  var highlightActiveLine = sharedModule3["highlightActiveLine"];
  var highlightActiveLineGutter = sharedModule3["highlightActiveLineGutter"];
  var highlightSpecialChars = sharedModule3["highlightSpecialChars"];
  var highlightTrailingWhitespace = sharedModule3["highlightTrailingWhitespace"];
  var highlightWhitespace = sharedModule3["highlightWhitespace"];
  var hoverTooltip = sharedModule3["hoverTooltip"];
  var keymap = sharedModule3["keymap"];
  var layer = sharedModule3["layer"];
  var lineNumberMarkers = sharedModule3["lineNumberMarkers"];
  var lineNumberWidgetMarker = sharedModule3["lineNumberWidgetMarker"];
  var lineNumbers = sharedModule3["lineNumbers"];
  var logException = sharedModule3["logException"];
  var panels = sharedModule3["panels"];
  var placeholder = sharedModule3["placeholder"];
  var rectangularSelection = sharedModule3["rectangularSelection"];
  var repositionTooltips = sharedModule3["repositionTooltips"];
  var runScopeHandlers = sharedModule3["runScopeHandlers"];
  var scrollPastEnd = sharedModule3["scrollPastEnd"];
  var showDialog = sharedModule3["showDialog"];
  var showPanel = sharedModule3["showPanel"];
  var showTooltip = sharedModule3["showTooltip"];
  var tooltips = sharedModule3["tooltips"];
  ...
  // tools/bundle-src/codemirror-html-bundle.js
  window.EditorWorkbenchCodeMirror = window.EditorWorkbenchCodeMirror || {};
  window.EditorWorkbenchCodeMirror.html = html;
})();
