...
var EditorWorkbenchCodeMirrorMarkdownBundle = (() => {
  // codemirror-global-shim:@codemirror/state
  var sharedModule = globalThis.EditorWorkbenchCodeMirror && globalThis.EditorWorkbenchCodeMirror.modules && globalThis.EditorWorkbenchCodeMirror.modules["@codemirror/state"];
  if (!sharedModule) {
    throw new Error("@codemirror/state runtime is not available.");
  }
  var Annotation = sharedModule["Annotation"];
  var AnnotationType = sharedModule["AnnotationType"];
  var ChangeDesc = sharedModule["ChangeDesc"];
  var ChangeSet = sharedModule["ChangeSet"];
  var CharCategory = sharedModule["CharCategory"];
  var Compartment = sharedModule["Compartment"];
  var EditorSelection = sharedModule["EditorSelection"];
  var EditorState = sharedModule["EditorState"];
  var Facet = sharedModule["Facet"];
  var Line = sharedModule["Line"];
  var MapMode = sharedModule["MapMode"];
  var Prec = sharedModule["Prec"];
  var Range = sharedModule["Range"];
  var RangeSet = sharedModule["RangeSet"];
  var RangeSetBuilder = sharedModule["RangeSetBuilder"];
  var RangeValue = sharedModule["RangeValue"];
  var SelectionRange = sharedModule["SelectionRange"];
  var StateEffect = sharedModule["StateEffect"];
  var StateEffectType = sharedModule["StateEffectType"];
  var StateField = sharedModule["StateField"];
  var Text = sharedModule["Text"];
  var Transaction = sharedModule["Transaction"];
  var codePointAt = sharedModule["codePointAt"];
  var codePointSize = sharedModule["codePointSize"];
  var combineConfig = sharedModule["combineConfig"];
  var countColumn = sharedModule["countColumn"];
  var findClusterBreak = sharedModule["findClusterBreak"];
  var findColumn = sharedModule["findColumn"];
  var fromCodePoint = sharedModule["fromCodePoint"];

  // codemirror-global-shim:@codemirror/view
  var sharedModule2 = globalThis.EditorWorkbenchCodeMirror && globalThis.EditorWorkbenchCodeMirror.modules && globalThis.EditorWorkbenchCodeMirror.modules["@codemirror/view"];
  if (!sharedModule2) {
    throw new Error("@codemirror/view runtime is not available.");
  }
  var BidiSpan = sharedModule2["BidiSpan"];
  var BlockInfo = sharedModule2["BlockInfo"];
  var BlockType = sharedModule2["BlockType"];
  var BlockWrapper = sharedModule2["BlockWrapper"];
  var Decoration = sharedModule2["Decoration"];
  var Direction = sharedModule2["Direction"];
  var EditorView = sharedModule2["EditorView"];
  var GutterMarker = sharedModule2["GutterMarker"];
  var MatchDecorator = sharedModule2["MatchDecorator"];
  var RectangleMarker = sharedModule2["RectangleMarker"];
  var ViewPlugin = sharedModule2["ViewPlugin"];
  var ViewUpdate = sharedModule2["ViewUpdate"];
  var WidgetType = sharedModule2["WidgetType"];
  var __test = sharedModule2["__test"];
  var activateHover = sharedModule2["activateHover"];
  var closeHoverTooltip = sharedModule2["closeHoverTooltip"];
  var closeHoverTooltips = sharedModule2["closeHoverTooltips"];
  var crosshairCursor = sharedModule2["crosshairCursor"];
  var drawSelection = sharedModule2["drawSelection"];
  var dropCursor = sharedModule2["dropCursor"];
  var getDialog = sharedModule2["getDialog"];
  var getDrawSelectionConfig = sharedModule2["getDrawSelectionConfig"];
  var getPanel = sharedModule2["getPanel"];
  var getTooltip = sharedModule2["getTooltip"];
  var gutter = sharedModule2["gutter"];
  var gutterLineClass = sharedModule2["gutterLineClass"];
  var gutterWidgetClass = sharedModule2["gutterWidgetClass"];
  var gutters = sharedModule2["gutters"];
  var hasHoverTooltips = sharedModule2["hasHoverTooltips"];
  var highlightActiveLine = sharedModule2["highlightActiveLine"];
  var highlightActiveLineGutter = sharedModule2["highlightActiveLineGutter"];
  var highlightSpecialChars = sharedModule2["highlightSpecialChars"];
  var highlightTrailingWhitespace = sharedModule2["highlightTrailingWhitespace"];
  var highlightWhitespace = sharedModule2["highlightWhitespace"];
  var hoverTooltip = sharedModule2["hoverTooltip"];
  var keymap = sharedModule2["keymap"];
  var layer = sharedModule2["layer"];
  var lineNumberMarkers = sharedModule2["lineNumberMarkers"];
  var lineNumberWidgetMarker = sharedModule2["lineNumberWidgetMarker"];
  var lineNumbers = sharedModule2["lineNumbers"];
  var logException = sharedModule2["logException"];
  var panels = sharedModule2["panels"];
  var placeholder = sharedModule2["placeholder"];
  var rectangularSelection = sharedModule2["rectangularSelection"];
  var repositionTooltips = sharedModule2["repositionTooltips"];
  var runScopeHandlers = sharedModule2["runScopeHandlers"];
  var scrollPastEnd = sharedModule2["scrollPastEnd"];
  var showDialog = sharedModule2["showDialog"];
  var showPanel = sharedModule2["showPanel"];
  var showTooltip = sharedModule2["showTooltip"];
  var tooltips = sharedModule2["tooltips"];

  // codemirror-global-shim:@codemirror/language
  var sharedModule3 = globalThis.EditorWorkbenchCodeMirror && globalThis.EditorWorkbenchCodeMirror.modules && globalThis.EditorWorkbenchCodeMirror.modules["@codemirror/language"];
  if (!sharedModule3) {
    throw new Error("@codemirror/language runtime is not available.");
  }
  var DocInput = sharedModule3["DocInput"];
  var HighlightStyle = sharedModule3["HighlightStyle"];
  var IndentContext = sharedModule3["IndentContext"];
  var LRLanguage = sharedModule3["LRLanguage"];
  var Language = sharedModule3["Language"];
  var LanguageDescription = sharedModule3["LanguageDescription"];
  var LanguageSupport = sharedModule3["LanguageSupport"];
  var ParseContext = sharedModule3["ParseContext"];
  var StreamLanguage = sharedModule3["StreamLanguage"];
  var StringStream = sharedModule3["StringStream"];
  var TreeIndentContext = sharedModule3["TreeIndentContext"];
  var bidiIsolates = sharedModule3["bidiIsolates"];
  var bracketMatching = sharedModule3["bracketMatching"];
  var bracketMatchingHandle = sharedModule3["bracketMatchingHandle"];
  var codeFolding = sharedModule3["codeFolding"];
  var continuedIndent = sharedModule3["continuedIndent"];
  var defaultHighlightStyle = sharedModule3["defaultHighlightStyle"];
  var defineLanguageFacet = sharedModule3["defineLanguageFacet"];
  var delimitedIndent = sharedModule3["delimitedIndent"];
  var ensureSyntaxTree = sharedModule3["ensureSyntaxTree"];
  var flatIndent = sharedModule3["flatIndent"];
  var foldAll = sharedModule3["foldAll"];
  var foldCode = sharedModule3["foldCode"];
  var foldEffect = sharedModule3["foldEffect"];
  var foldGutter = sharedModule3["foldGutter"];
  var foldInside = sharedModule3["foldInside"];
  var foldKeymap = sharedModule3["foldKeymap"];
  var foldNodeProp = sharedModule3["foldNodeProp"];
  var foldService = sharedModule3["foldService"];
  var foldState = sharedModule3["foldState"];
  var foldable = sharedModule3["foldable"];
  var foldedRanges = sharedModule3["foldedRanges"];
  var forceParsing = sharedModule3["forceParsing"];
  var getIndentUnit = sharedModule3["getIndentUnit"];
  var getIndentation = sharedModule3["getIndentation"];
  var highlightingFor = sharedModule3["highlightingFor"];
  var indentNodeProp = sharedModule3["indentNodeProp"];
  var indentOnInput = sharedModule3["indentOnInput"];
  var indentRange = sharedModule3["indentRange"];
  var indentService = sharedModule3["indentService"];
  var indentString = sharedModule3["indentString"];
  var indentUnit = sharedModule3["indentUnit"];
  var language = sharedModule3["language"];
  var languageDataProp = sharedModule3["languageDataProp"];
  var matchBrackets = sharedModule3["matchBrackets"];
  var sublanguageProp = sharedModule3["sublanguageProp"];
  var syntaxHighlighting = sharedModule3["syntaxHighlighting"];
  var syntaxParserRunning = sharedModule3["syntaxParserRunning"];
  var syntaxTree = sharedModule3["syntaxTree"];
  var syntaxTreeAvailable = sharedModule3["syntaxTreeAvailable"];
  var toggleFold = sharedModule3["toggleFold"];
  var unfoldAll = sharedModule3["unfoldAll"];
  var unfoldCode = sharedModule3["unfoldCode"];
  var unfoldEffect = sharedModule3["unfoldEffect"];
      ...
      props: [
        ...
        /* @__PURE__ */ foldNodeProp.add({
          ...
          "JSXSelfClosingTag JSXOpenTag"(tree) {
            var _a;
            let name2 = (_a = tree.firstChild) === null || _a === void 0 ? void 0 : _a.nextSibling, close = tree.lastChild;
  ...
  var autoCloseTags = /* @__PURE__ */ EditorView.inputHandler.of((view, from, to, text, defaultInsert) => {
    ...
    let closeTags = state.changeByRange((range) => {
      ...
      if (state.doc.sliceString(head - 1, head) != text || around.name == "JSXAttributeValue" && around.to > head) ;
        ...
        if (base2 && empty.from == head - 2 && ((name2 = elementName(state.doc, base2.firstChild, head)) || ((_a = base2.firstChild) === null || _a === void 0 ? void 0 : _a.name) == "JSXFragmentTag")) {
          let insert = `${name2}>`;
  ...
  function elementName2(doc, tree, max = doc.length) {
    ...
    return name2 ? doc.sliceString(name2.from, Math.min(name2.to, max)) : "";
  }
  ...
  var autoCloseTags2 = /* @__PURE__ */ EditorView.inputHandler.of((view, from, to, text, insertTransaction) => {
    ...
    let closeTags = state.changeByRange((range) => {
      ...
      if (didType && text == ">" && after.name == "EndTag") {
        ...
        if (((_b = (_a = tag.parent) === null || _a === void 0 ? void 0 : _a.lastChild) === null || _b === void 0 ? void 0 : _b.name) != "CloseTag" && (name2 = elementName2(state.doc, tag.parent, head)) && !selfClosers2.has(name2)) {
  ...
  // tools/bundle-src/codemirror-markdown-bundle.js
  window.EditorWorkbenchCodeMirror = window.EditorWorkbenchCodeMirror || {};
  window.EditorWorkbenchCodeMirror.markdown = markdown;
})();
