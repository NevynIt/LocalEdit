...
var EditorWorkbenchCsvBundle = (() => {
  ...
  // tools/bundle-src/csv-bundle.js
  var import_papaparse = __toESM(require_papaparse_min());
  function parse(source, options = {}) {
    return import_papaparse.default.parse(source || "", {
      delimiter: options.delimiter || "",
      skipEmptyLines: false
    });
  }
  window.EditorWorkbenchCsv = {
    Papa: import_papaparse.default,
    parse
  };
})();
/*! For license information please see csv.bundle.js.LEGAL.txt */
